    ...
    <main className="-mb-4">
      ...
      >
        <div className="bg-neutral-950/75 w-full h-full pt-48 p-3">
          <h1 className="font-bold text-5xl text-center">
            Welcome to Bristol STA
          </h1>
          <h2 className="font-semibold text-2xl text-center text-neutral-300 py-3">
            The backstage technical society for students in Bristol
          </h2>
        </div>
        <div className="bg-neutral-950/75 w-full h-full pb-48 p-3 flex items-center justify-center">
          <Link href="/get-involved" className="sta-btn">
            Get involved
          </Link>
          <Link href="/contact-us" className="sta-btn yellow-btn">
            Contact us
          </Link>
        </div>
      </div>
      <StaTextContainer className="grid md:grid-cols-2 my-6 w-full text-center md:text-left">
        <div>
          ...
          <StaText className="my-auto">
            Bristol Stage Technicians’ Association is a Bristol SU Society that
            provides technical event support to student and community groups
            across Bristol.
          </StaText>
          <Link href="/about-us" className="m-3 sta-btn">
            More About the STA
          </Link>
        </div>
