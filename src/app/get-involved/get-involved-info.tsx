  ...
  return (
    ...
    <StaTextContainer>
        ...
        <StaLinkButton href="https://discord.com/invite/t2D7TCcSU5">
          <Image src="/images/icons/discord.svg" width={100} height={100} alt={"Discord Icon"} className={"size-6 fill-current"} aria-hidden="true"/>
          Join the Discord
        </StaLinkButton>
      ...
      <StaTextContainer>
        ...
        <StaLinkButton href="https://www.bristolsu.org.uk/groups/sta-stage-technicians-association-3e02" className={"teal-btn"}>
          <Image src="/images/icons/su.png" width={100} height={100} alt={"Bristol SU Icon"} className={"size-6 fill-current"} aria-hidden="true"/>
          SU Membership Page
        </StaLinkButton>
      </StaTextContainer>
      <StaTextContainer>
