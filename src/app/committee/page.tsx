...
function CommitteeLi({
  ...
  return (
    <li>
      <Link href={`mailto:${mail ? mail : role.toLowerCase()}@bristolsta.com`}>
        {role}
      </Link>{" "}
      – {people}
    </li>
    ...
    <main>
      ...
      <StaTextContainer>
        ...
        <ul>
          ...
          <CommitteeLi
            role="Equalities & Welfare Officer"
            mail="equalities"
            people="Ameerah"
          />
          <CommitteeLi role="Treasurer" people="Miles" />
          <CommitteeLi
            role="Training Managers"
            mail="training"
            people="Bryn & Jonathan"
          />
          <CommitteeLi
            role="Workshop and Equipment Managers"
            mail="workshop"
            people="Archie & Phoebe"
          />
          <CommitteeLi
            role="Hires and Externals Managers"
            mail="hires"
            people="Tiago & Okan"
          />
          <CommitteeLi
            role="Publicity Officers"
            mail="publicity"
            people="Pola & Yara"
          />
          <CommitteeLi
            role="Social Secretaries"
            mail="social"
            people="Harriet & Veronica"
          />
          ...
          <CommitteeLi
            role="Confectionary Managers"
            mail="confectionary"
            people="Elanor & Freddie"
          />
        </ul>
      </StaTextContainer>
    </main>
