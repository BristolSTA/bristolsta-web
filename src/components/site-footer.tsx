...
function SocialLi({
  ...
  return (
    <li
      className={
        "size-6 opacity-75 hover:opacity-100 transition-opacity duration-100 flex items-center justify-center"
      }
    >
      <Link
        href={href}
        className="focus:outline-2 focus:outline-neutral-900 focus:ring-4 focus:ring-purple-400"
      >
        <Image
  ...
  return (
    <footer className={`bg-neutral-950 p-4 hide-on-nav-open`}>
      <StaTextContainer className="flex flex-col md:flex-row md:gap-8 justify-center items-center">
        ...
        <Image
          src="/images/bristolsu-logo.png"
          width={2183}
          height={503}
          alt="Bristol SU: Supporting Student Groups logo"
          className={"h-12 w-auto"}
        />
        <Image
          src={"/images/theatre-green-book-preliminary.png"}
          width={1299}
          height={427}
          alt="Theatre Green Book: making theatre sustainable (Preliminary 2025) logo"
      ...
      <StaTextContainer className="flex flex-col justify-center items-center">
        <ul className={"flex flex-row gap-6 justify-center items-center"}>
          <SocialLi
            href="https://www.instagram.com/stabristol/"
            iconFile="instagram.svg"
            alt="Instagram"
          />
          <SocialLi
            href="https://www.tiktok.com/@bristolsta?lang=en"
            iconFile="tiktok.svg"
            alt="TikTok"
          />
          <SocialLi
            href="https://discord.gg/t2D7TCcSU5"
